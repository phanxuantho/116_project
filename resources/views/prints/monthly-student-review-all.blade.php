...
<head>
    <meta charset="UTF-8">
    <title>In Toàn bộ Danh sách Rà soát</title>
    <style>
        body { font-family: 'Times New Roman', Times, serif; font-size: 13px; }
        .page-container {
            page-break-after: always; /* Tạo ngắt trang sau mỗi danh sách lớp */
        }
        ...
        <div class="page-container">
            <div class="container">
                <div class="header">
                    <table>
                        <tr>
                            <td style="text-align: center;">TRƯỜNG ĐẠI HỌC TÂY NGUYÊN<br>{{ strtoupper($class->faculty->faculty_name ?? '') }}</td>
                ...
                <div class="class-info">
                    <strong>Lớp:</strong> {{ $class->class_name }}
                </div>
                <table class="data">
                    <thead>
                        <tr>
                ...
                <div class="footer-content">
                    <p>Danh sách gồm {{ count($class->students) }} sinh viên.</p>
